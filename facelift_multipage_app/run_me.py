...
from app import app
from apps import home, gene_input, struct_sig_run_check, download_page, struct_sig_error, download_error, data_explorer
...
def display_page(pathname):
    ...
    elif pathname == '/apps/databasenav':
        return data_explorer.layout
