                    ...
                    dbc.Col([
                        html.Div(
                            dcc.Upload(
                                ...
                                children=html.Div([
                                    html.H6('Drag and Drop or', style={'display': 'inline', 'padding_top':200}),
                                    html.A('Select File', style={'display': 'inline', 'margin-left':6}),
                                    html.P('of line separated genes or uniprot codes')
                                    ]),
                                style={
                                    'width': '95%',
                                    'height': '150px',
...
def update_style(dimension):
    if dimension != '3d':
        return [{'display':'none'},
                ...
                {'display':'none'},
                {'display':'none'}]
    return[{'display':'block', 'marginLeft':'100px', 'marginTop':'27px'},
           {'display':'block', 'marginLeft':'100px', 'width':'35%'},
           {'display':'block', 'marginLeft':'100px', 'marginTop':'27px'},
           {'display':'block', 'marginLeft':'100px', 'width':'35%'}]
